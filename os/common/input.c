...
void keyboard_press_callback(struct bus_controller *bus, unsigned key) {
  ...
  switch (key) {
    ...
    // L/R flippers.
    case CEN64_KEY_K: si->input[1] |= 1 << 5; break;
    case CEN64_KEY_M: si->input[1] |= 1 << 4; break;

    // A/Z/B/S buttons.
    case CEN64_KEY_G: si->input[0] |= 1 << 7; break;
    case CEN64_KEY_J: si->input[0] |= 1 << 6; break;
    case CEN64_KEY_N: si->input[0] |= 1 << 5; break;
    case CEN64_KEY_O: si->input[0] |= 1 << 4; break;

    // D-pad.
    case CEN64_KEY_E: si->input[0] |= 1 << 1; break;
    case CEN64_KEY_F: si->input[0] |= 1 << 0; break;
    case CEN64_KEY_C: si->input[0] |= 1 << 3; break;
    case CEN64_KEY_D: si->input[0] |= 1 << 2; break;

    // C-pad.
    case CEN64_KEY_I: si->input[1] |= 1 << 1; break;
    case CEN64_KEY_2: si->input[1] |= 1 << 0; break;
    case CEN64_KEY_L: si->input[1] |= 1 << 3; break;
    case CEN64_KEY_H: si->input[1] |= 1 << 2; break;
  }
}
